...
<body>
  <div class="container">
    <div class="col-10 m-auto">
      <p class="h1 text-center p-5">Table Dosen</p>
      <a href="create.php" class="btn btn-primary">Tambah Dosen</a>
      <table class="table table-hover table-bordered border-primary mt-3">
        ...
        <tbody>
          <tr>
            ...
            <td scope="row"><?= $data['nidn'] ?></td>
            <td scope="row"><?= $data['jenjangpendidikan'] ?></td>
            <td scope="row">
